...
mixin _$HomeState {
  ...
  List<HotAndNewData> get trendingMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get tensDaramasMovieList =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<HotAndNewData> tensDaramasMovieList,
...
class _$HomeStateCopyWithImpl<$Res, $Val extends HomeState>
  ...
  $Res call({
    ...
    Object? tensDaramasMovieList = null,
    ...
    return _then(_value.copyWith(
      ...
      trendingMovieList: null == trendingMovieList
          ...
          : trendingMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      tensDaramasMovieList: null == tensDaramasMovieList
          ? _value.tensDaramasMovieList
          : tensDaramasMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl(
      ...
      required final List<HotAndNewData> tensDaramasMovieList,
      ...
      : _pastYearMovieList = pastYearMovieList,
        ...
        _tensDaramasMovieList = tensDaramasMovieList,
  ...
  final List<HotAndNewData> _tensDaramasMovieList;
  @override
  List<HotAndNewData> get tensDaramasMovieList {
    if (_tensDaramasMovieList is EqualUnmodifiableListView)
      return _tensDaramasMovieList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_tensDaramasMovieList);
  }
  ...
  @override
  String toString() {
    return 'HomeState(stateId: $stateId, pastYearMovieList: $pastYearMovieList, trendingMovieList: $trendingMovieList, tensDaramasMovieList: $tensDaramasMovieList, southIndianMovieList: $southIndianMovieList, trendingTvList: $trendingTvList, isLoading: $isLoading, hasError: $hasError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._tensDaramasMovieList, _tensDaramasMovieList) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_tensDaramasMovieList),
